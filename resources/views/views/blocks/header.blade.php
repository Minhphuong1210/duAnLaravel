                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="welcome-message">
                            <p>Welcome to Chu Minh Phương__Sell Engagement and Wedding Rings</p>
                        </div>
                    </div>
                    <div class="col-lg-6 text-right">
                        <div class="header-top-settings">
                            <ul class="nav align-items-center justify-content-end">
                                ...
                                <li class="language">
                                    <img src="{{ asset('assets/client/corano/assets/img/icon/en.png') }}"
                                        alt="flag"> English
                                    <i class="fa fa-angle-down"></i>
                                    <ul class="dropdown-list">
                                        <li><a href="#"><img
                                                    src="{{ asset('assets/client/corano/assets/img/icon/en.png') }}"
                                                    alt="flag"> english</a></li>
                                        <li><a href="#"><img
                                                    src="{{ asset('assets/client/corano/assets/img/icon/fr.png') }}"
                    ...
                    <div class="col-lg-2">
                        <div class="logo">
                            <a href="{{ route('trangChu') }}">
                                <img src="{{ asset('assets/client/corano/assets/img/logo/logo.png') }}"
                                    alt="Brand Logo">
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="main-menu-area">
                            <div class="main-menu">
                                ...
                                <nav class="desktop-menu">
                                    <ul>
                                        <li class="active"><a href="{{ route('trangChu') }}">Home </a>
                                        </li>

                                        <li><a href="">shop <i class="fa fa-angle-down"></i></a>
                                            <ul class="dropdown">
                                                @php
                                                    $danhMuc = \App\Models\DanhMuc::where('trang_thai', 1)->get();
                                                ...
                                                @foreach ($danhMuc as $item)
                                                    ...
                                                    <li>
                                                        <a
                                                            href="/category/{{ $item->id }}">{{ $item->ten_danh_muc }}</a>
                                                    </li>
                                                    {{-- @endforeach --}}
                                                @endforeach
                                            </ul>
                    ...
                    <div class="col-lg-4">
                        <div
                            ...
                            <div class="header-search-container">
                                ...
                                <form class="header-search-box d-lg-none d-xl-block" action="{{route('search')}}" method="POST">
                                    @csrf
                                    <input type="text" placeholder="Search entire store hire"
                                        class="header-search-field" name="keyword">
                            ...
                            <div class="header-configure-area">
                                <ul class="nav justify-content-end">
                                    ...
                                    <li>
                                        <a href="{{route('cart.listCart')}}" class="minicart-btn">
