                    ...
                    <div class="blog-carousel-active slick-row-10 slick-arrow-style">
                     ...
                     <div class="blog-post-item">
                        <figure class="blog-thumb">
                            <a href="{{route('post.detail',$posts->id)}}">
                                <img src="{{ Storage::url($posts->hinh_anh) }}"
                                    alt="blog image">
                            </a>
                        </figure>
                        <div class="blog-content">
                            <div class="blog-meta">
                                <p>{{$posts->created_at->format('d-m-Y')}} | {{$posts->User->name}}</p>
                            </div>
                            <h5 class="blog-title">
                                <a href="{{route('post.detail',$posts->id)}}">{{$posts->tieu_de}}</a>
                            </h5>
                        </div>
                    </div>
                     @endforeach
