        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12 ">
                            <form action="{{ route('admins.nguoidungs.store') }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select"  name="role">
                                                ...
                                                <option value="{{\App\Models\User::ROLE_ADMIN}}">{{\App\Models\User::ROLE_ADMIN}}</option>
                                                <option value="{{\App\Models\User::ROLE_USER}}">{{\App\Models\User::ROLE_USER}}</option>
                                              </select>
                                        </div>
                                    </div>
                                </div>
