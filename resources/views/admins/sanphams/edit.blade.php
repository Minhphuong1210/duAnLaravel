                                    ...
                                    <div class="col-4">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="simpleinput"
                                                ...
                                                name="ma_san_pham" value="{{ $sanPham->ma_san_pham }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="simpleinput"
                                                ...
                                                name="ten_san_pham" value="{{ $sanPham->ten_san_pham }}"
                                                placeholder="Tên danh mục ">
                                            @error('ten_san_pham')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" id="simpleinput"
                                                ...
                                                name="gia_san_pham" value="{{ $sanPham->gia_san_pham }}"
                                                placeholder="Tên danh mục ">
                                            @error('gia_san_pham')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" id="simpleinput"
                                                ...
                                                name="so_luong" value="{{ $sanPham->so_luong }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="mo_ta_ngan" id="mo_ta_ngan" cols="30" rows="3"
                                                class="form-control @error('mo_ta_ngan') is-invalid @enderror" 
                                                placeholder="Ngày nhập">{{$sanPham->mo_ta_ngan}}</textarea>
                                            @error('mo_ta_ngan')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="file" id="simpleinput" class="form-control"
                                                name="hinh_anh_san_pham" onchange="showImage(event)" id="hinh_anh">
                                            <img src="{{ Storage::url($sanPham->hinh_anh_san_pham) }}"
                                                alt="Hình ảnh sản phẩm" style="width:150px; " id="img_danh_muc">
                                        </div>
...
@section('js')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var old_content = `{!! $sanPham->mo_ta_anh !!}`;
